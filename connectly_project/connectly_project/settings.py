...
SECRET_KEY = 'django-insecure-^2+vjzc+_tk2w2e7ge=@eticlen=yqz(+rn-h01*fohy41l+s%'
...
# Make session cookies secure (only sent via HTTPS)
SESSION_COOKIE_SECURE = True

# Make CSRF cookies secure (only sent via HTTPS)
